...
export class Points extends Scene {
    constructor() {
        super('Points');
    }
    ...
    async create() {
        ...
        const title = this.add.text(50, 110, 'POINTS PAGE', { fill: '#0f0', fontSize: '60px' ,strokeThickness: 1, stroke: '#0f0', fontFamily: 'playwritereg',padding: { right: 35}}).setAlpha(0);

        const richTitle = this.add.text(150, 400, 'POINTS', { fill: '#0f0', fontSize: '30px', strokeThickness: 1, stroke: '#0f0', fontFamily: 'playwritereg' });
